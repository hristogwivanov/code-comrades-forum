    ...
    const onRegisterSubmit = async (values) => {
        ...
        try {
           ...
           // console.log(publicUserData);
            ...
            publicUserData.profilePic='https://eitrawmaterials.eu/wp-content/uploads/2016/09/person-icon.png';

            const userPublicDataResult = await userService.create(publicUserData);
